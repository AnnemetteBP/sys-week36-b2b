...
namespace Retailer
{
    class RetailerProgram
    {
        ...
        {
            using (bus = RabbitHutch.CreateBus("host=stingray-01.rmq.cloudamqp.com;virtualHost=dslmjuud;username=dslmjuud;password=8XLswZaA5FI2JxQOiT0J8BrCgFj2STVn"))
            {
                ...
                // WRITE CODE HERE!
                bus.SendReceive.Receive<OrderReplyMessage>("warehouseToReatilerQueue",
